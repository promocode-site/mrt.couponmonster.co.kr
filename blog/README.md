# 블로그 폴더 설명 (mrt.couponmonster.co.kr)
...
주소는 `https://mrt.couponmonster.co.kr/blog/agoda-coupon/` 가 됩니다.
...
| `{{canonical}}` | 글의 정식 주소 | https://mrt.couponmonster.co.kr/blog/agoda-coupon/ |
